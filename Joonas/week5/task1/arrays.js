...
// Print those values. 
numbers.sort((a,b) => b - a);
document.querySelector('#task11').textContent = `Largest is ${numbers[0]} and the smallest is ${ numbers[4]}`;
